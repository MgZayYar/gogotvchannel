    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form action="{{ route('movies.update',$id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="downlink" name="link1">{{$link1}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="downlink" class="col-sm-2 col-form-label"> Link 2</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="downlink" name="link2">{{$link2}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="downlink" class="col-sm-2 col-form-label"> Link 3</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="downlink" name="link3">{{$link3}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10">
