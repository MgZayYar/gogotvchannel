<x-backend>
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1> <i class="icofont-list"></i> New Movie Cast </h1>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form action="{{ route('movie_cast.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="photo_id" class="col-sm-2 col-form-label"> ActorName </label>
                                <div class="col-sm-10">
